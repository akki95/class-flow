...
| $\\Delta$ | Number of solutions | Graph |
|---|---|---|
| $\\Delta > 0$ | 2 distinct real solutions | Crosses x-axis twice |
| $\\Delta = 0$ | 1 real solution (repeated) | Touches x-axis once |
| $\\Delta < 0$ | No real solutions | Does not cross x-axis |
...
| | Linear | Exponential |
|---|---|---|
| Pattern | Add a constant each period | Multiply by a constant each period |
| Table clue | Constant differences | Constant ratios |
| Equation form | $f(x) = mx + b$ | $f(x) = a \\cdot b^x$ |
